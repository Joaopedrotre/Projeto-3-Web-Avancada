...
// ---------------------------------------------------------------------
function filtrarEstoqueCritico(produtos) {
...
function calcularRankingProdutos(itens) {
    const totaisPorProduto = itens.reduce((mapa, item) => {
...
// ---------------------------------------------------------------------
function formatarValoresEmReais(valores) {
    return valores.map((valor) => formatadorMoeda.format(valor));
}
// ---------------------------------------------------------------------
// RENDERIZAÇÃO NA TELA (com tratamento de cenário vazio)
// ---------------------------------------------------------------------
function exibirEstadoVazio(idContainer, mensagem = 'Nenhum dado registrado') {
